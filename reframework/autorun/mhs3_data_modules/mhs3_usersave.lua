...
function usersave.get_relay()
    ...
    local ok_save, save = pcall(manager.get_field, manager, "_UserSaveData")
    ...
    local ok_relay, relay = pcall(save.get_field, save, "_UserRelay")
...
function usersave.get_story_param()
    ...
    local relay = usersave.get_relay()

    -- Get the _StoryParam field
    local ok_story, story = pcall(relay.get_field, relay, "_StoryParam")
